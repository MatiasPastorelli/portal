          ...
          <div class="col-lg-9 col-md-9">
            <div class="card">
                <div class="card-header">
                    <h5 class="subtitulo-isbast text-center">Crear Oferta</h5>
                </div>
                <form action="{{ asset('/ofertaStore') }}" method="post">
                      ...
                      <div class="card-body m-3">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" step="0.01" name="valorOferta" class="form-control" >
                                </div>
                            </div>
                      </div>
                    </div>
                    ...
                    <div class="my-2 my-lg-0" style="float: right">
                        <ul class="list-inline main-nav-right" style="align:Center ">
                           ...
                           <li class="list-inline-item">
                                <a class="btn btn-link btn-sm" href="/oferta">Cancelar</a>
                           </li>
                        </ul>
                     </div>
                     <br>
