          ...
          <div class="col-lg-9 col-md-9">
            <div class="card">
                <div class="card-header">
                    <h5 class="subtitulo-isbast text-center">Actualizar caracteristica {{$caracteristicas->nombreCaracteristica}}</h5>
                </div>
                <form action="{{ asset('/caracteristicaUpdate') }}" method="post">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <input type="hidden" name="idCaracteristica" value="{{ $caracteristicas->idCaracteristica }}">
                    <div>
                      <div class="card-body m-3">
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <label>Nombre Caracteristica<span class="text-danger">*</span></label>
                                    <input type="text" name="nombreCaracteristica" class="form-control" value="{{$caracteristicas->nombreCaracteristica}}">
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control custom-select" name="idTipoCaracteristica">
                                        ...
                                        @if ($caracteristicas->idTipoCaracteristica == $tipo->idTipoCaracteristica)
