          ...
          <div class="col-lg-9 col-md-9">
            <div class="card">
                <div class="card-header">
                    <h5 class="subtitulo-isbast text-center">Crear Moneda</h5>
                </div>
                <form action="{{ asset('/monedaStore') }}" method="post">
                      ...
                      <div class="card-body m-3">
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="nombreMoneda" class="form-control" >
                                </div>

                                <div class="form-group col-md-6">
                                    <label>Tipo cambio<span class="text-danger">*</span></label>
                                    <input type="number" step="0.01" name="tipoCambio" class="form-control" >
                                </div>
                            </div>
                      </div>
                    </div>
